...
class PascalVOCdataset(ThreadedDataset):
    ...
    _mask_labels = {0: 'background', 1: 'aeroplane', 2: 'bicycle', 3: 'bird',
                    ...
                    19: 'train', 20: 'tv_monitor', 21: 'void'}
    ...
    def filenames(self):
        ...
        if self._filenames is None:
            ...
            if self.which_set == 'train_extra':
                ...
                for k, v in get_file_names(file_txt, False).items():
    ...
    def __init__(self,
        ...
        self.path_extra = os.path.join(
            self.path, 'datasets', 'PASCAL-VOC_Extra')
        self.sharedpath_extra = ('/data/lisa/data/segmentation/PASCAL_Extension')
